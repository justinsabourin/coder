    ...
    return <div className="projects-container">
        <GridList cols={4} padding={15} className="grid-list">
            {props.projects.map((project) => (
                ...
                titleStyle={{color: 'black', fontFamily: 'Open Sans', fontSize: '1.8em'}}
                titleBackground="rgba(0, 188, 212, 0.4)"
                subtitle={<span style={{color: 'black', fontFamily: 'Open Sans', fontSize: '1.2em'}}>by <b>{project.creator}</b></span>}
